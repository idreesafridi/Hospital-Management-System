...
@section('content')
    <div class="content container-fluid content-wrap">
        <form action="{{ route('admin_update', $admin->id) }}" id="patientform" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <input type="text" name="phone_number" id="phone_number"
                                        class="form-control floating" value="{{ $admin->profile->phone_number }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-focus">
                                    <input type="date" name="date_of_birth" id="date_of_birth"
                                        ...
                                        value="{{ $admin->profile->date_of_birth ? \Carbon\Carbon::parse($admin->profile->date_of_birth)->format('Y-m-d') : '' }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control" placeholder="About me" name="about" id="about" rows="4">{{ $admin->profile->about }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mt-auto">
                <div class="col-md-12">
                    <div class="submit-sec">
                        ...
                        <a href="{{ route('admin_view', $admin->id) }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
