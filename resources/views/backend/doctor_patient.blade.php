                                ...
                                <tbody>
                                    @foreach ($patients as $patient)
                                        <tr>
                                                ...
                                                <h2 class="table-avatar">
                                                    <a href="#" data-bs-target="#patientlist"
                                                        data-bs-toggle="modal"><img class="avatar avatar-img"
                                                            src="{{ asset('backend') }}/{{ $patient->patient->profile->profile_image ?? 'blog_attachments/no_image.png' }}"
                                                            alt="User Image"></a>
                                                    <a href="#" data-bs-target="#patientlist"
                                                        data-bs-toggle="modal"><span
                                                            class="user-name">{{ $patient->patient->name ?? 'N/A' }}</span>
                                                        <span class="text-muted">Male, 40 Years Old</span></a>
                                                </h2>
                                            </td>
                                            <td><span
                                                    class="user-name">{{ $patient->patient->created_at->format(env('GLOBALE_DATE_FORMAT')) ?? 'N/A' }}
                                                </span></td>
                                            ...
                                            <td>
                                                <a class="edit-pro"
                                                    href="{{ route('patient_view', $patient->patient->id) }}"><i
