        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In porta luctus est interdum pretium. Fusce
                        id tortor fringilla, suscipit turpis ac, varius ex. Cras vel metus ligula. Nam enim ligula, bibendum
                        a iaculis ut, cursus id augue. Proin vitae purus id tortor vehicula scelerisque non in libero.</p>
                    <p class="mb-0">Nulla non turpis sit amet purus pharetra sollicitudin. Proin rutrum urna ut suscipit
                        ullamcorper. Proin sapien felis, dignissim non finibus eget, luctus vel purus. Pellentesque
                        efficitur congue orci ornare accumsan. Nullam ultrices libero vel imperdiet scelerisque. Donec vel
                        mauris eros.</p>
                </div>
                <div class="col-md-6">
                </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="category-subox pb-0 d-flex flex-wrap w-100">
                        ...
                        <div class="subox-img">
                            <div class="subox-circle">
                                <img src="assets/img/icons/vect-01.png" alt="" width="42">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 category-col d-flex">
                    <div class="category-subox pb-0 d-flex flex-wrap w-100">
                        ...
                        <div class="subox-img">
                            <div class="subox-circle">
                                <img src="assets/img/icons/vect-02.png" alt="" width="42">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 category-col d-flex">
                    <div class="category-subox pb-0 d-flex flex-wrap w-100">
                        ...
                        <div class="subox-img">
                            <div class="subox-circle">
                                <img src="assets/img/icons/vect-03.png" alt="" width="42">
                            </div>
                        </div>
                    </div>
                </div>
